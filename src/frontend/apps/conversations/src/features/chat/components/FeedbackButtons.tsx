import { Button, Modal, ModalSize, TextArea } from '@openfun/cunningham-react';
...
const FEEDBACK_CATEGORIES = [
  ...
  { id: 'incomplete', label: 'Réponse incomplète' },
  { id: 'off_topic', label: 'Hors sujet' },
  { id: 'poorly_formatted', label: 'Mal formatée' },
  { id: 'too_long', label: 'Trop longue' },
  { id: 'sources_missing', label: 'Sources manquantes' },
] as const;
    ...
    <>
      ...
      >
        <Button
          ...
          icon={
            selectedFeedback === 'positive' ? <ThumbUpFilled /> : <ThumbUp />
          }

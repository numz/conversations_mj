...
class JudilibreAPI:
    ...
    def __init__(self) -> None:
        ...
        oauth_url = getattr(settings, "LEGIFRANCE_OAUTH_URL", "")
    ...
    async def search(
        ...
        with track_request("judilibre_search", query=query, page=page) as ctx:
            ...
            try:
                ...
                log_api_response(
                    "judilibre_search", ctx.duration_ms, True, result_count=len(response.results)
                )
                return response
    ...
    async def get_decision(
        ...
        with track_request("judilibre_decision", decision_id=decision_id) as ctx:
            ...
            try:
                ...
                log_api_response(
                    "judilibre_decision", ctx.duration_ms, True, decision_id=decision_id, found=True
                )
                return response

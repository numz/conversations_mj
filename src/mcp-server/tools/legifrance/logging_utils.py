...
Standalone version (no Django or Langfuse dependencies).
"""
...
class StructuredLogger:
    ...
    def __init__(self, name: str = "legifrance"):
        ...
        self.logger = logging.getLogger(f"legifrance.{name}")
...
class PerformanceMetrics:
    ...
    def record_call(
        ...
        self._total_duration_ms[operation] = (
            self._total_duration_ms.get(operation, 0) + duration_ms
        )

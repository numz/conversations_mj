...
| MCP_TOOLS_ENABLED                               | When true, bypasses all local tools and loads tools from MCP server(s) configured in MCP_SERVERS_CONFIG                           | false                                                   |
| MCP_SERVERS_CONFIG                              | JSON dict of MCP servers: `{"name": {"url": "http://host:port/mcp", "headers": {...}}, ...}`                                      | {}                                                      |
...
| MARKDOWN_SANITIZE_ENABLED                       | Enable HTML sanitization in markdown rendering (rehype-sanitize)                                                                  | true                                                    |
| CODE_DOWNLOAD_ENABLED                           | Enable download button on code blocks                                                                                             | true                                                    |
| CONVERSATION_ERROR_REDIRECT_ENABLED             | Redirect to /chat on conversation load error instead of showing empty chat                                                        | true                                                    |
| RICH_CLIPBOARD_ENABLED                          | Copy messages as rich text (HTML + plain text) for pasting into Word, Google Docs, etc.                                           | true                                                    |
...
| CONVERSATION_GROUPING_ENABLED                   | Group conversations by date (Today, Yesterday, This week...) in the left panel. See [Feature Flags](feature-flags.md)             | true                                                    |
...
| STREAMING_CANCEL_EVENT_ENABLED                  | Enable `threading.Event` for more reliable stream cancellation (in addition to Redis cache)                                       | false                                                   |
